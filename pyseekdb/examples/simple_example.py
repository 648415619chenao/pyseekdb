...
Note: This script must be run with `if __name__ == '__main__':` protection
because the embedding function uses 'spawn' multiprocessing method which
requires the main code to be protected.
"""
import pyseekdb
...
def main():
    """Main function containing all the example code"""
...
if __name__ == '__main__':
    """
    This protection is required when using 'spawn' multiprocessing method.
    The embedding function uses spawn to create isolated subprocesses, which
    requires the main code to be protected to avoid infinite recursion.
    """
    main()
